...
for jj=1:4
    ...
    m=10000;
    cont=0;
    before_P=Domestic_5year(:,P1);
    after_P=Domestic_5year(:,P2);
    while cont<m
...
xlswrite('Domestic_Gravity_Movement_region_contribute.xlsx',[row_title;num2cell([P3_sector_contribute,Sector_TWU_Dir_contribute_all])]);
